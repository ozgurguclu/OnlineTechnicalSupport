...
namespace OnlineTechnicalSupport
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/datepickerJS").Include("~/Scripts/bootstrap-datepicker.js"));
            bundles.Add(new StyleBundle("~/Content/datepickerCSS").Include("~/Content/bootstrap-datepicker.css"));
        }
    }
}
