INSERT INTO Manager(Email, LoginName, LoginPassword, Name, Surname , DateOfCreate, ConfirmedEmail, Activated)
VALUES ('test@admin.com', 'admin123', '12345678', 'Admin', 'Test' , GETDATE(), 'Yes', 'Yes');

INSERT INTO Customer(Email, LoginName, LoginPassword, DateOfCreate, ConfirmedEmail, Activated)
VALUES ('test@user.com', 'user1234', '12345678' , GETDATE(), 'Yes', 'Yes');

INSERT INTO ProductCategory VALUES ('Masaüstü Bilgisayar');
INSERT INTO ProductCategory VALUES ('Dizüstü Bilgisayar');

INSERT INTO ProductModel VALUES ('Rog', 1);
INSERT INTO ProductModel VALUES ('Eagle', 2);

INSERT INTO Product VALUES ('R5000', 'R5000STRXMDM2021QWER', 'r5000.jpg', 1);
INSERT INTO Product VALUES ('E3000', 'E3000DOMNSLG2021QWER', 'e3000.png', 2);

INSERT INTO Asset VALUES ('FL5FDSYJR2D6AV', 'FBF56DHT6A', null, 1);
INSERT INTO Asset VALUES ('MGE65F1SDESH7K', 'HWD2GS92BT', null, 2);

INSERT INTO Issue VALUES ('Görüntüleme sorunları');
INSERT INTO Issue VALUES ('Ses sorunları');
INSERT INTO Issue VALUES ('Pil ve adaptör sorunları');
INSERT INTO Issue VALUES ('Sabit sürücü sorunları');
INSERT INTO Issue VALUES ('Donanım perfomans sorunları');
INSERT INTO Issue VALUES ('Sistem başlangıç sorunları');
INSERT INTO Issue VALUES ('Güncelleme sorunları');
INSERT INTO Issue VALUES ('Yazılım sorunları');
INSERT INTO Issue VALUES ('Diğer');

INSERT INTO ServiceRequestStatus VALUES ('Cihaz alındı');
INSERT INTO ServiceRequestStatus VALUES ('İşlem için bekliyor');
INSERT INTO ServiceRequestStatus VALUES ('Onarılıyor');
INSERT INTO ServiceRequestStatus VALUES ('Teslime hazır');
INSERT INTO ServiceRequestStatus VALUES ('Teslim edildi');

INSERT INTO IssueReportStatus VALUES ('Aktif');
INSERT INTO IssueReportStatus VALUES ('İşleme alındı');
INSERT INTO IssueReportStatus VALUES ('Askıya alındı');
INSERT INTO IssueReportStatus VALUES ('Yanıtlandı');
INSERT INTO IssueReportStatus VALUES ('Kapandı');

INSERT INTO ChatStatus VALUES ('Aktif değil');
INSERT INTO ChatStatus VALUES ('Devam ediyor');
INSERT INTO ChatStatus VALUES ('Kapandı');

INSERT INTO ComputerSkill VALUES ('Mükemmel');
INSERT INTO ComputerSkill VALUES ('İyi');
INSERT INTO ComputerSkill VALUES ('Yeterli');
INSERT INTO ComputerSkill VALUES ('Kötü');
INSERT INTO ComputerSkill VALUES ('Çok kötü');

INSERT INTO Education VALUES ('İlkokul-Ortaokul');
INSERT INTO Education VALUES ('Lise');
INSERT INTO Education VALUES ('Üniversite');
INSERT INTO Education VALUES ('Yüksek Lisans');
INSERT INTO Education VALUES ('Doktora');

INSERT INTO Job VALUES ('Programcı/Bilgisayar Mühendisi');
INSERT INTO Job VALUES ('Tasarımcı/Editör/Yönetmen/Mimar');
INSERT INTO Job VALUES ('Ofis çalışanı/Devlet memuru');
INSERT INTO Job VALUES ('Medya/Halkla İlişkiler/Basın');
INSERT INTO Job VALUES ('Ticaret');
INSERT INTO Job VALUES ('Bağımsız (Freelancer)');
INSERT INTO Job VALUES ('Öğrenci');
INSERT INTO Job VALUES ('Öğretim görevlisi');
INSERT INTO Job VALUES ('Sağlık/Hukuk ');
INSERT INTO Job VALUES ('Ulaşım sektörü/Şoför');
INSERT INTO Job VALUES ('Finans/Sigorta');
INSERT INTO Job VALUES ('Emekli');
INSERT INTO Job VALUES ('İşçi');
INSERT INTO Job VALUES ('Ev hanımı');
INSERT INTO Job VALUES ('Yönetici/Müdür');
INSERT INTO Job VALUES ('Serbest meslek');
INSERT INTO Job VALUES ('Diğer');

INSERT INTO Gender VALUES ('Erkek');
INSERT INTO Gender VALUES ('Kadın');
